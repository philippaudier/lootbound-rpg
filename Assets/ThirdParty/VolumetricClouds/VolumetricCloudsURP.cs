...
public class VolumetricCloudsURP : ScriptableRendererFeature
{
    ...
    #if UNITY_6000_0_OR_NEWER
        [Obsolete("Used only in Compatibility Mode (OnCameraSetup).")]
    #endif
        private readonly RTHandle[] cloudsRTHandles = new RTHandle[2]; // avoid GC allocation

    #if UNITY_6000_0_OR_NEWER
        [Obsolete("Compatibility Mode only. Use RecordRenderGraph instead.")]
    #endif
...
#pragma warning disable CS0612, CS0618 // Obsolete members used for Compatibility Mode
            if (outputDepth)
            {
...
#pragma warning disable CS0618 // ConfigureTarget is obsolete in Compatibility Mode
